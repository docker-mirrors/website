...
export function ImageDetail({ tags, detail, logo }: ImageDetailProps) {
  ...
  return (
    <TooltipProvider delayDuration={0}>
      <div className="container flex flex-col items-start justify-between space-y-2 py-4 sm:flex-row sm:items-center sm:space-y-0 md:h-18 sticky bg-background top-0 z-30 border-b mx-auto max-w-[980px]">
